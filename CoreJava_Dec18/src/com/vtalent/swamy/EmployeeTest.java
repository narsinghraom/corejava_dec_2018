...
public class EmployeeTest {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		do {
			...
			switch (option) {
			case 1:
				System.out.println("select your array size");
				...
				break;
			case 2:
				//System.out.println("delete from my  Array");
				eb = new EmployeeBeen();
				/*System.out.println("please enter  your id ");
				int i1 = sc.nextInt();
				eb.setEmpid(i1);*/
				...
				break;
			case 3:
				//System.out.println("search an employee id from my  Array");
				eb = new EmployeeBeen();
				System.out.println("please enter  your id ");
				int i2 = sc.nextInt();
				eb.setEmpid(i2);
				...
				break;
			case 4:
				//System.out.println("print the all the employees from my  Array");
