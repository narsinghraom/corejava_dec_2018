...
public class Stringmethods {
		...
		public static void main(String[] args) {
			...
			System.out.println("Char at index 2 " + String.charAt(2));
			...
			System.out.println("SubString of string: "+ String.substring(8));
			System.out.println("SubString of String: "+ String.substring(8, 12));
	 ...
	 * String S3 = S1 + S2; S3 = S3.toUpperCase();
