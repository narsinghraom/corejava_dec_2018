...
interface Abc1 {
	// in interface for variables and methods it default take it as public
	// static final.
	float pi = 3.14f;
	int k = 0;
...
public class AbcInterface {
	public static void main(String[] args) {
		...
		abc.k = 5; // we can't assaign a value to the interface variables
					// because those variables and methods are static final.
		abc.function(2);
		abc.function(2, 3);
