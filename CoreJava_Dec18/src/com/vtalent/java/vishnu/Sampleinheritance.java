...
public class Sampleinheritance {
	public static void main(String[] args) {
		...
		/*
		 * st.function(25, 1.5f); st.function((int)st.l); st.function(5);
		 * st.function(st.f1); st.function(st.f1,st.f2);
		 */
		...
		/*
		 * st1.function(st.f1); st1.function(st.f1,st.f2);
		 * System.out.println(st.l); System.out.println(st.f1);
		 * System.out.println(st.f2); System.out.println(st.i);
		 */
		System.out.println("==================");
