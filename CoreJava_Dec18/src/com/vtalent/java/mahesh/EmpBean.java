...
class Employe extends EmpBean {
	...
	/*
	 * if (earray != null) { System.out.println("Enter The Employee Name:");
	 * String x = in.next(); for (int i = 0; i <= earray.length - 1; i++) { emp
	 * = earray[i]; if (null!=emp){ if (x == emp.getEmpName()) {
	 * System.out.println("Employee ID: " + emp.getEmpID() + "      " +
	 * "Employee Name: " + emp.getEmpName() + "      " +
	 * "Employee Mobile Number: " + emp.getEmpMobileNumber() + "      " +
	 * "Employee Salary: " + emp.getEmpSalary()); } } else {
	 * System.out.println("Enter a Valid Name"); } } } else {
	 * System.out.println("Insert  the Employee Data first"); } }
	 */
