...
public class EmployeeCollectionTest {
	...
	public void insertData() {
		...
		for (int i = 0; i <= size - 1; i++) {
			...
			EmployeeCollectionOperation.insertData(emp);
	...
	public static void main(String[] args) {
		EmployeeCollectionTest empt = new EmployeeCollectionTest();
		EmployeeCollectionOperation empo = new EmployeeCollectionOperation();
