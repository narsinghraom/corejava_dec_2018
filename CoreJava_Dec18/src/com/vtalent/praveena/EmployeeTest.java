...
public class EmployeeTest {
	...
	if(choice==8)
	{
		...
		//EmployeeTask.Serializable();
			EmployeeOperationWithList.Serializable();
		}
		catch(Exception e)
		{
	...
	for(int i=0;i<=size-1;i++)
	{
		...
		EmployeeOperationWithList.insertData(emp);
	}
	}
	...
	case 2:
		...
		try
		{
			EmployeeOperationWithList.printAllEmployeeData();
	...
	case 3:
		...
		EmployeeOperationWithList.updateData(emp.getemployeeID());
		break;
	case 4:
		...
		EmployeeOperationWithList.deleteData(emp1.getemployeeID());
		break;
	case 5:
		...
		EmployeeOperationWithList.SearchEmployee(emp2.getemployeeID());
		}
		catch(Exception e)
		{
	...
	case 6:
		...
		EmployeeOperationWithList.getLoan(emp3.getemployeeID());
		break;
	case 7:
		...
		EmployeeOperationWithList.deserialization();
		}
		catch(Exception e)
		{
		}
