...
public class EmployeeCollectionsOperation {
	...
	private static EmployeeCollectionsOperation EmployeeCollectionOperations;
	...
	public static void insertData(Employee emp) {
		if (empArray != null) {
			...
			int result=dbo.InsertDataWithStatement(emp);
		}
	}
	...
	public static void InsertInnerLogic() {
		...
		emp.setID(EmployeeCollectionsOperation
		...
		emp.setMobileNumber(EmployeeCollectionsOperation
				.MobileLogic(EmployeeCollectionTask1.input.next()));
		System.out.println("Enter EmployeePackage:- ");
		double Pp = EmployeeCollectionsOperation
